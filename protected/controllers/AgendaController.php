...
class AgendaController extends Controller {
    ...
    public function actionView($id) {
        ...
        if (!Yii::app()->user->checkAccess('agenda_view')) {
    ...
    public function actionCreate() {
        // is current user has the required privilege ?
        if (!Yii::app()->user->checkAccess('agenda_create')) {
            throw new CHttpException(
            403, 'You are not authorized to perform this action.'
            );
        }
    ...
    public function actionUpdate($id) {
        // is current user has the required privilege ?
        if (!Yii::app()->user->checkAccess('agenda_update')) {
            throw new CHttpException(
            403, 'You are not authorized to perform this action.'
            );
        }
    ...
    public function actionDelete($id) {
        // is current user has the required privilege ?
        if (!Yii::app()->user->checkAccess('agenda_delete')) {
            throw new CHttpException(
            403, 'You are not authorized to perform this action.'
            );
        }
    ...
    public function actionIndex() {
        // is current user has the required privilege ?
        if (!Yii::app()->user->checkAccess('agenda_index')) {
            throw new CHttpException(
            403, 'You are not authorized to perform this action.'
            );
        }
    ...
    public function actionAdmin() {
        // is current user has the required privilege ?
        if (!Yii::app()->user->checkAccess('agenda_admin')) {
            throw new CHttpException(
            403, 'You are not authorized to perform this action.'
            );
        }
