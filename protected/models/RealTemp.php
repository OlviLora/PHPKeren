...
/**
 * This is the model class for table "real_temp".
 *
 * The followings are the available columns in table 'real_temp':
 * @property integer $id_agenda
 * @property string $catatan
 * @property string $keputusan
 * @property string $deadline
 */
class RealTemp extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RealTemp the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_agenda, catatan, keputusan, deadline', 'safe', 'on'=>'search'),
		);
	}
