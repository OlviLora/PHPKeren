<section id="bottom" class="">
    <div class="container bottom"> 
        <div class="row-fluid ">
            <!--<div class="span3">-->
                <h5>About us</h5>
                <p>We are students from Del Institute of Technology. Our team named SYP_TI1_01<br>
                    This is our Second Year Project</p>
            <!--</div><!-- /span3-->
...
<footer>
    <div class="footer">
        <div class="container">
            Copyright &copy; 2014. Designed by SYP_TI1_01
        </div>
    </div>
</footer>
